...
class RewardSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.type_reward = validated_data.get(
                'type_reward',
                instance.type_reward
        )
        instance.delivery_data = validated_data.get(
                'delivery_data',
                instance.delivery_data
        )
        instance.delivery_place = validated_data.get(
                'delivery_place',
                instance.delivery_place
        )
