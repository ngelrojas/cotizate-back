# Generated by Django 3.0.3 on 2020-03-04 02:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Bolivianos', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('before_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currencies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Currency')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.AddField(
            model_name='campaing',
            name='raised',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Raised'),
        ),
        migrations.AddField(
            model_name='campaing',
            name='tags',
