...
class BiographySerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.email_2 = validated_data.get(
                'email_2',
                instance.email_2
        )
        instance.b_facebook = validated_data.get(
                'b_facebook',
                instance.b_facebook
        )
        instance.b_twitter = validated_data.get(
                'b_twitter',
                instance.b_twitter
        )
        instance.b_linkedin = validated_data.get(
                'b_linkedin',
                instance.b_linkedin
        )
        instance.b_instagram = validated_data.get(
                'b_instagram',
                instance.b_instagram
        )
        instance.is_representative = validated_data.get(
                'is_representative',
                instance.is_representative
        )
        instance.personal_website = validated_data.get(
                'personal_website',
        ...
        instance.company_nit = validated_data.get(
                'company_nit',
                instance.company_nit
        )
        instance.company_city = validated_data.get(
                'company_city',
                instance.company_city
        )
        instance.company_phone = validated_data.get(
                'company_phone',
                instance.company_phone
        )
        ...
        instance.company_facebook = validated_data.get(
                'company_facebook',
                instance.company_facebook
        )
        instance.company_twitter = validated_data.get(
                'company_twitter',
                instance.company_twitter
        )
        instance.company_linkedin = validated_data.get(
                'company_linkedin',
                instance.company_linkedin
        )
        instance.company_instagram = validated_data.get(
                'company_instagram',
                instance.company_instagram
        )
